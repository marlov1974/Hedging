...
- files inspected,
- files changed,
- Data Viewer view groups created/changed,
- raw canonical view behavior,
- projected view behavior,
- market/internal view behavior,
- component concept visibility added or intentionally skipped,
- tests added/updated,
- `npm test` result,
